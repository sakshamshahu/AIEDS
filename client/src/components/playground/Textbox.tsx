    ...
    <div className="my-[5rem] flex justify-center items-center gap-8 w-full h-fit">
      <div className="w-[90%] h-fit flex flex-col justify-start items-center z-5 ">
        ...
        <div className="flex justify-start items-center gap-6 w-full my-2">
          <button
            className="font-poppins text-primary-white focus:bg-textbox-border px-3 py-1 bg-transparent rounded-full flex justify-center items-center transition ease-in-out duration-200"
                  ...
                  {menuOption === 0 ? (
                    <>
                      ...
                      <div className="rounded-2xl border border-textbox-border border-1 w-fit h-fit padding px-4 py-[6px] bg-textbox-background">
                        <p className="text-primary-white font-natosans font-bold text-[1.2rem] leading-none">
                          PDF File 01.pdf
                        </p>
                      </div>
                      <div className="rounded-2xl border border-textbox-border border-1 w-fit h-fit padding px-4 py-[6px] bg-textbox-background">
            ...
            <div className="relative px-2 w-full flex justify-end items-center h-[3rem]">
              ...
              {menuOption === 1 && (
                <button
                  ...
                  className="border border-textbox-border border-1 flex justify-center items-center w-fit px-3 h-[3rem] rounded-md"
                >
                  <svg
                    viewBox="0 0 24 24"
                    className="w-6 h-6"
                  ...
                  <p className="text-primary-white text-[1rem] font-natosans font-semibold">
                    MARKDOWN
                  </p>
                </button>
              )}
            ...
            {menuOption === 0 ? (
              <div className="w-full h-full flex flex-col justify-start items-start gap-3 px-3 pt-3">
                ...
                <div className="w-full h-fit flex flex-col justify-center items-center">
                  ...
                  />
                  <button
                    className="w-[30rem] border border-white border-dashed border-1 rounded-[10px] h-[13rem] flex justify-center items-center"
                    onClick={() =>
                ...
                <div className="border border-textbox-border border-1 rounded-[1rem] w-full h-[50.5rem] bg-tertiary-background z-0 mb-6 flex flex-col justify-between items-start px-2">
                  <div className="w-full h-full px-2 my-2 flex flex-col justify-start items-start gap-3 overflow-y-auto">
                    <div className="w-full h-fit flex justify-start items-center">
                      <p className="bg-textbox-background w-fit h-fit px-3 py-1 font-natosans font-mdeium rounded-[20px] text-primary-white">
                    ...
                    <div className="w-full h-fit flex justify-start items-center">
                      <p className="bg-textbox-background w-fit h-fit px-3 py-1 font-natosans font-mdeium rounded-[20px] text-primary-white">
                        ...
                        It was popularised hi these
                      </p>
                    </div>
                    <div className="w-full h-fit flex justify-end items-center">
                      <p className="bg-textbox-border w-fit h-fit px-3 py-1 font-natosans font-mdeium rounded-[20px] text-primary-white">
                        survived not only five centuries, but also the leap into{" "}
                      </p>
                    </div>
                  </div>
                  <div className="py-1 px-2 w-full h-[3.5rem] mb-1">
                    <div className="w-full h-full border border-textbox-border border-1 rounded-[10px] flex justify-between items-center px-2 bg-textbox-background/10">
                      <div className="w-full h-full px-2 overflow-y-auto">
                        <input
                          type="text"
                          className="w-full h-full px-1 bg-transparent outline-none text-primary-white text-[1.1rem] placeholder:opacity-60"
